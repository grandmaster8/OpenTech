 ...
 * changeable driver slots (i.e. which can be changed in the robot GUI,
...
public interface Container extends Item {
     ...
     * @return the slot type provided by that dynamic slot driver.
     ...
     * @return the maximum tier supported by that dynamic slot driver.
     */
