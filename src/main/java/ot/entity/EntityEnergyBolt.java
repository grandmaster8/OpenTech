        ...
        extends Entity
{
    ...
    public void onUpdate()
    {
        ...
        if(block != Blocks.air){
            AxisAlignedBB alignedBB = block.getCollisionBoundingBoxFromPool(worldObj, (int)this.posX, (int)this.posY, (int)this.posZ);
            if(alignedBB != null && alignedBB.isVecInside(Vec3.createVectorHelper(this.posX + motionX, this.posY + motionY, this.posZ  + motionZ))){
                setDead();
            }
        }
